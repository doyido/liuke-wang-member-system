...
document.querySelectorAll('.hero-logo, .mini-logo').forEach(function(img){ img.src = LOGO_B64; });
var fav = document.querySelector('link[rel="icon"]'); if (fav) fav.href = LOGO_B64;
