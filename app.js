...
renderCoeffs();
renderSummary();
// GitHub部署：用SVG内嵌logo替换图片文件引用
var LOGO_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">'+
'<defs><linearGradient id="sh" x1="0" y1="0" x2="0" y2="1">'+
'<stop offset="0" stop-color="#1a4a7a"/><stop offset="1" stop-color="#0d2a4a"/></linearGradient></defs>'+
'<path d="M60 8 L100 22 V58 C100 88 82 106 60 114 C38 106 20 88 20 58 V22 Z" fill="url(#sh)" stroke="#E8A33D" stroke-width="3"/>'+
'<path d="M42 48 L48 38 L56 46 L60 36 L64 46 L72 38 L78 48 Z" fill="#E8A33D"/>'+
